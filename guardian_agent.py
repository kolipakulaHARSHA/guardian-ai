...
def create_guardian_agent(model_name: str = "gemini-2.5-pro-preview-03-25", verbose: bool = True) -> AgentExecutor:
    """
    Create the Guardian AI agent with all tools.
    ...
    # Create prompt with tool calling
    prompt = ChatPromptTemplate.from_messages([
        ("system", """You are Guardian AI, an expert compliance and code analysis assistant. You help users ensure their code follows regulatory requirements.
...
Always think step by step and explain your reasoning."""),
    ...
    # Create the agent using tool calling
